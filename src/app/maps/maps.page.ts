...
export class MapsPage implements OnInit {
  scenes: string[] = ['Ionic', 'Android', 'PHP', 'Huawei', 'Wipro']
  sc: string[] = ['HPlatform', 'MEnterprise', 'WApplicationss', 'MCompany', 'Awesome']
  cat: string = "https://picsum.photos/id/237/200/300"
  map: any;
  marker: any[];
  markers: any[];
  markerCluster: any;
